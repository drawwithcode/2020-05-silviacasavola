...
function draw() {
  ...
  image(img2, windowWidth/3, windowHeight/4, 210, 210);
  image(img3, windowWidth/3, windowHeight/4, 210, 210);
  image(img4, windowWidth/2, windowHeight/3, 210, 210);
  image(img5, windowWidth/2, windowHeight/3, 210, 210);
  image(img6, windowWidth/2, windowHeight/3, 210, 210);
